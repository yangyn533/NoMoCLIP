...
def main(parser):
    ...
    for rbp in rbps:
        ...
        for i in range(0, fold):
            ...
            seq_train_dimone = con_seq_1D(os.path.join(set_path, 'Sequential_Feature', rbp, '{}', 'train',
                                                    'RNAonly', 'encoding_features/').format(i))
            seq_val_dimone = con_seq_1D(os.path.join(set_path, 'Sequential_Feature', rbp, '{}', 'val', 'RNAonly',
            ...
            seq_test_dimone = con_seq_1D(os.path.join(set_path, 'Sequential_Feature', rbp, 'test', 'RNAonly',
                                                      'encoding_features/'))
