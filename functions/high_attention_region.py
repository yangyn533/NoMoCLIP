...
def high_attention(args):
    ...
    seq_test_dimone = con_seq_1D(os.path.join(set_path, 'before/Sequential_Feature', 'RNAonly', 'encoding_features/'))
    ...
    seq_test_dimone_mut = con_seq_1D(os.path.join(set_path, 'after/Sequential_Feature', 'RNAonly', 'encoding_features/'))
