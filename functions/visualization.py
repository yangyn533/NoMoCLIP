...
def plot_saliency(X, W, nt_width=101, norm_factor=3, str_null=None, outdir="results/"):
    ...
    plt.text(x=trace_width - 400, y=10, s='NoMoCLIP', fontsize=4)
